...
def convert_cmd(
    ...
    ocr: Annotated[bool, typer.Option("--ocr/--no-ocr", help="Enable best-effort Tesseract OCR for standalone images.")] = False,
    ocr_languages: Annotated[str, typer.Option(help="Tesseract language set.")] = "eng+rus",
